...
namespace RequestPortal.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public CompaniesController(RequestPortalContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Companies != null ? 
                          ...
                          Problem("Entity set 'RequestPortalContext.Companies'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'RequestPortalContext.Companies'  is null.");
            }
            var company = await _context.Companies.FindAsync(id);
            if (company != null)
            {
