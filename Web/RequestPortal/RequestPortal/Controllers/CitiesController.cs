...
namespace RequestPortal.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public CitiesController(RequestPortalContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Cities != null ? 
                          ...
                          Problem("Entity set 'RequestPortalContext.Cities'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'RequestPortalContext.Cities'  is null.");
            }
            var city = await _context.Cities.FindAsync(id);
            if (city != null)
            {
