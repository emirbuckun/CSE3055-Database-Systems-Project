...
namespace RequestPortal.Controllers
{
    public class UserRolesController : Controller
    {
        ...
        public UserRolesController(RequestPortalContext context)
        {
            _context = context;
        }
        ...
        {
            var requestPortalContext = _context.UserRoles.Include(u => u.User);
        ...
        public async Task<IActionResult> Create([Bind("UserId,Role")] UserRole userRole)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,Role")] UserRole userRole)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'RequestPortalContext.UserRoles'  is null.");
            }
            var userRole = await _context.UserRoles.FindAsync(id);
            if (userRole != null)
            {
